...
public class PathfinderDashboardReportWriter {
    ...
    public void writeReport(
        ...
        writeReport(outputPath, title, subtitle, elapsedMillis, runs, List.of());
    }
    ...
    public PathfinderDashboardModels.Report createReport(
        ...
        return createReport(title, subtitle, elapsedMillis, runs, List.of());
    }
    ...
    public PathfinderDashboardModels.RunRecord createRunRecord(
        ...
        return createRunRecord(name, category, details, result, config, result.isReached(), null, null);
    }
