...
public interface ShortestPathConfig extends Config {
    ...
    @ConfigSection(
        name = "Planted Spirit Trees",
        description = "Options for planted spirit trees",
        position = 40,
        closedByDefault = true
    )
    ...
    @ConfigItem(
        keyName = "useSpiritTreeEtceteria",
        name = "Etceteria",
        description = "Whether to include the planted spirit tree in Etceteria",
        position = 41,
        section = sectionSpiritTrees
    )
    default boolean useSpiritTreeEtceteria() {
        return false;
    }

    @ConfigItem(
        keyName = "useSpiritTreeBrimhaven",
        name = "Brimhaven",
        description = "Whether to include the planted spirit tree in Brimhaven",
        position = 42,
        section = sectionSpiritTrees
    )
    default boolean useSpiritTreeBrimhaven() {
        return false;
    }

    @ConfigItem(
        keyName = "useSpiritTreePortSarim",
        name = "Port Sarim",
        description = "Whether to include the planted spirit tree in Port Sarim",
        position = 43,
        section = sectionSpiritTrees
    )
    default boolean useSpiritTreePortSarim() {
        return false;
    }

    @ConfigItem(
        keyName = "useSpiritTreeHosidius",
        name = "Hosidius",
        description = "Whether to include the planted spirit tree in Hosidius",
        position = 44,
        section = sectionSpiritTrees
    )
    default boolean useSpiritTreeHosidius() {
        return false;
    }

    @ConfigItem(
        keyName = "useSpiritTreeFarmingGuild",
        name = "Farming Guild",
        description = "Whether to include the planted spirit tree in the Farming Guild",
        position = 45,
        section = sectionSpiritTrees
    )
    default boolean useSpiritTreeFarmingGuild() {
        return false;
    }
